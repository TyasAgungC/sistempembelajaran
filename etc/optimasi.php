...
<table width="427" border="1">
  <tr>
    <td width="205">&nbsp;Permintaan Terbesar 
      <input type='text' class='masukan' name='A1'></td>
    <td width="206">&nbsp;Permintaan Terkecil 
      <input type='text' class='masukan' name='A2'></td>
  </tr>
  <tr>
    <td>&nbsp;Persediaan Banyak  <input type='text' class='masukan' name='B1'> </td>
    <td>&nbsp;Persediaan Sedikit <input type='text' class='masukan' name='B2'> </td>
  </tr>
  <tr>
    <td>&nbsp; Produksi Maksimal
     <input type='text' class='masukan' name='C1'></td>
    <td>&nbsp;Produksi Minimal
     <input type='text' class='masukan' name='C2'> </td>
  </tr>
  <tr>
    <td>&nbsp; Permintaan yang di inginkan
     <input type='text' class='masukan' name='X'> </td>
    <td>&nbsp;Persediaan di gudang <br>
     <input type='text' class='masukan' name='Y'></td>
  </tr>
</table>
  <br>
     <input type='submit' >
