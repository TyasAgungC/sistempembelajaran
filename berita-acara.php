...
$res1=mysql_query("SELECT * FROM dsn");
$userRow1=mysql_fetch_array($res1);
$res2=mysql_query("SELECT * FROM informasi");
...
<html lang="id">
<head>
	<title>Pengumuman | Modul Interaktif</title>
	<meta charset="utf-8">
...
<body bgcolor="grey">
	<div id="wrapper">
		...
		<div id="contentbox">
			<div id="content">
				<div id="berita">Pengumuman</div>
				<div id="j-berita">1. <?php echo $userRow2['Judul']; ?></div>
				<div id="j-isi"><?php echo $userRow2['Isi']; ?></div>
				<div id="j-pos">
					Diposkan oleh: <?php echo $userRow1['Nama']; ?>
					<br />
					Diedit pada tanggal : <?php echo $userRow2['Tanggal']; ?>
				</div>
				<div id="garis"></div>
			</div>
			</div>
