...
<head>
	...
	<link rel="stylesheet" href="tampilanmhs.css" type="text/css" />
	...
	<div id="wrapper">
		...
		<div id="contentbox">
			...
			<div id="content">
				<?php
				include 'koneksi.php';
				$sql = mysqli_query($cnn, 'SELECT * FROM mhs');	
				?>
					<div class="lap"><font color="blue" face="arial" size="5">Data Mahasiswa</font></div>
						...
						while ($row = mysqli_fetch_array($sql)) {?>
							...
							<div class="offering"><?php echo $row['off'];?></div>
							<div class="pen">
								<form action="editmhs.php" method="POST">
								<a href="updatemhs.php"><i class="fa fa-pencil-square" style="font-size: 25px; color: #00CCCC"></i></a>
								</form>
							...
							<a href="dm.php"><input type="submit" name="tambah" size="35" value="+ Tambah Mahasiswa" class="tombol"></a>
