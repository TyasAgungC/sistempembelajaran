		...
		<div id="contentbox">
			<div id="content">
				...
				<form action="editmhs.php" method="POST">
					<div><h2><font color="orange">Edit Data Mahasiswa</h2></div>
					<div>NIM <input type="text" name="nim" id="nim" autofocus maxlength="12" size="12" required />
					</div><br />
					<div>Nama <input type="text" name="user" id="user" size="30" required />
					</div><br />
					...
					<div>Password <input type="password" name="pass" id="pass" maxlength="8" size="8" /> 
					</div><br />
					
					<div>
						<input type="submit" size="35" name="daftar" value="Daftar" class="tombol"> 
					</div>
