...
<head>
	...
	<link rel="stylesheet" href="tampilandosen.css" type="text/css" />
	...
	<div id="wrapper">
		...
		<div id="contentbox">
			...
			<div id="content">
				<?php
				include 'koneksi.php';
				$sql = mysqli_query($cnn, 'SELECT * FROM dsn');	
				?>
					<div class="lap"><font color="blue" face="arial" size="5">Data Dosen</font></div>
						...
						while ($row = mysqli_fetch_array($sql)) {?>
							...
							<form action="updatedosen.php">
								<input type="submit" name="tambah" size="35" value="+ Edit Dosen" class="tombol">
							</form>
			</div>
