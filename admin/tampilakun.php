	...
	<div id="wrapper">
		...
		<div id="contentbox">
			...
			<div id="content">
				<?php
				include 'koneksi.php';
				$sql = mysqli_query($cnn, 'SELECT * FROM akun');	
				?>
					<div class="lap"><font color="blue" face="arial" size="5">Data Akun</font></div>
						...
						while ($row = mysqli_fetch_array($sql)) {?>
							...
							<a href="updateakun.php"><input type="submit" name="tambah" size="35" value="+ Edit Admin" class="tombol"></a>
			</div>
