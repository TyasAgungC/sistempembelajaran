		...
		<div id="contentbox">
			<div id="content">
				...
				<form action="editakun.php" method="POST">
					<div><h2><font color="orange">Edit Data Admin</h2></div>

					<div>Nama <input type="text" name="user" id="user" autofocus size="30" required />
					</div><br />
					<div>Username <input type="text" name="user" id="user" size="20" required />
					</div><br />
					<div>Password <input type="password" name="pass" id="pass" maxlength="12" size="20" required /> 
					</div><br />
					<div>Confirm Password <input type="password" name="pass" id="pass" maxlength="12" size="20" required /> 
					</div><br />
