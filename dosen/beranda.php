...
<body bgcolor="grey">
	<div id="wrapper">
		...
		<div id="contentbox">
			<div id="content">
				<p><font color="blue" face="arial"size="5">Selamat datang</font></p>
				<div class="isi">
				<p align="justify">  Ini merupakan halaman khusus yang disediakan bagi Dosen Pengampu maupun Asisten Dosen yang dapat digunakan untuk mengedit materi pembelajaran, menambahkan soal evaluasi, memberikan penilaian dan juga menambahkan informasi terkait dengan kegiatan pembelajaran.</a></p>
				<p align="justify">  Selamat bekerja.</p>
				</div>
			</div>
		</div>
