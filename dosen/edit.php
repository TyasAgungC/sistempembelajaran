				...
				<ul>
					...
					<li><a href="#"><i class="fa fa-folder" style="color: orange;width: 137px;"><font face="arial"size="3"><b> Soal Evaluasi </b></font><i class="fa fa-caret-down" style="color: black" ;"></i></i></a>
						<ul>
							...
							<div class="txt2">
							<li><a href="studikasus.php"><font color="black">Studi Kasus</font></a></li></div>
						</ul>
					</li>
		...
		<div id="contentbox1">
			<div id="content">
				<div id="morelinks1">
					...
					<div class="style1"><u>B</u>ab : <input type="text" name="bab" /></div>
					<div class="style3"><u>S</u>ub Materi : <input type="text" name="sub"  /></div>
					<div class="style4"><u>U</u>rutan : <input type="text" name="urutansub" /></div>
					<div class="style5"><u>U</u>raian : </div><textarea name="uraian" rows="78" cols="58"></textarea>
					<div class="style6"><input type="submit" size="35" name="login" value="Simpan" class="tombol1"> 
					</div>
					</form>
				</div>
			</div>
