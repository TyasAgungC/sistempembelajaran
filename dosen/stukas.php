...
<head>
	...
	<link rel="stylesheet" href="soalstukas.css" type="text/css" />
...
<body bgcolor="grey">
	<div id="wrapper">
		...
		<div id="inner">
			...
			<div class="txt1">
				<div id="sidebar">
					<div><a href="studikasus.php">Enkapsulasi</a></div>
		...
		<div id="contentbox">
			<div id="content">
				<h3><font color="blue" face="arial">Soal Studi Kasus</font></h3>
				<div class="soal">Bab</div>
				<div class="soal3">Studi Kasus</div>
				<div class="garis"></div>
				<?php
				include 'koneksi.php';

				$sql = mysqli_query($cnn, 'SELECT * FROM stukas');	
				while ($row = mysqli_fetch_array($sql)) {
					?>
					<font color="teal" face="ebrima" size="4"><div class="tab1"><?php echo $row['Bab']; ?></div>
					<div class="gambar"><img width="500px" height="500px" src="files/<?php echo $row['Nama_file']; ?>" border='0' /></div>
					<div class="edit"><a href="editstukas.php"><i class="fa fa-pencil-square" style="color: #00CCCC; font-size:31px"></i></a></div>
					<div class="soal1"><?php echo $row['Kasus']; ?></div>
					<?php
				}
				?>
				<div class="garis1"></div>
				<div class="garis2"></div>
				<div><a href="tambahstukas.php"><input type="submit" size="35" name="login" value="+  Tambah Soal" class="tombol"></a>
				</div>
			</div>
		</div>
