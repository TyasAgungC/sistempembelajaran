...
<head>
	...
	<link rel="stylesheet" href="tambahsoal.css" type="text/css" />
...
<body bgcolor="grey">
	<div id="wrapper">
		...
		<div id="contentbox">
			<div id="content">
			<form action="soaldanjawabanpilgan.php" method="post">
				<div id="morelinks">
					<div class="mat">
						<div class="style">Soal</div>
					</div>
						<div class="style1"><u>M</u>ateri : 
							<select name="bab">
							<option value = "Enkapsulasi">Enkapsulasi</option>
							<option value = "Abstract Class">Abstract Class</option>
							<option value = "Interface">Interface</option>
							<option value = "Polimorfisme">Polimorfisme</option>
							</select>
						</div>
					
					<div class="style3"><u>K</u>ode Soal : <input type="text" name="kode" id="kode" size="33" /></div>
