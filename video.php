...
<html lang="id">
<head>
	<title>Tutorial | Video | Modul Interaktif</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
		...
		<div id="contentbox">
			<div class="scroll">
				<div id="content">
				<h1>Enkapsulasi</h1>
				<div id="urutan"> sebelumnya 5 6 7 <font face="Arial" size="2" color="teal"> 8 berikutnya </font> </div>
				<div id="video"><iframe width="600" height="300" src="https://www.youtube.com/watch?v=4Bs17UHIh0E&t=8s"></iframe></div>
				<div id="v-isi"> Apabila video tidak dapat berjalan dengan baik pada browser Anda maka Anda dapat mendownload video tersebut <a href="https://www.youtube.com/watch?v=4Bs17UHIh0E&t=8s"><font color="lightskyblue"> DISINI </font></a></div>
				</div>
			</div>
		</div>
